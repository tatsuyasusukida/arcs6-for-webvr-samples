...
MotorModel MotorModels[ConstParams::ACTUATOR_NUM] = {
    MotorModel(DEFAULT_TORQUE_CONSTANT, DEFAULT_MOMENT_OF_INERTIA, DEFAULT_VISCOUS_FRICTION_COEFFICIENT),
    MotorModel(DEFAULT_TORQUE_CONSTANT, DEFAULT_MOMENT_OF_INERTIA, DEFAULT_VISCOUS_FRICTION_COEFFICIENT),
    MotorModel(DEFAULT_TORQUE_CONSTANT, DEFAULT_MOMENT_OF_INERTIA, DEFAULT_VISCOUS_FRICTION_COEFFICIENT),
    MotorModel(DEFAULT_TORQUE_CONSTANT, DEFAULT_MOMENT_OF_INERTIA, DEFAULT_VISCOUS_FRICTION_COEFFICIENT),
    MotorModel(DEFAULT_TORQUE_CONSTANT, DEFAULT_MOMENT_OF_INERTIA, DEFAULT_VISCOUS_FRICTION_COEFFICIENT),
...
extern "C" void updateModeCallback(int controlFunctionsMode)
{
  if (controlFunctionsMode == 1)
  {
    ...
    {
      MotorModels[i] = MotorModel(DEFAULT_TORQUE_CONSTANT, DEFAULT_MOMENT_OF_INERTIA, DEFAULT_VISCOUS_FRICTION_COEFFICIENT);
